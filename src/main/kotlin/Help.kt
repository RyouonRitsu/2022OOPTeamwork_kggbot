...
object Help {
    val funcGroup: List<String> = listOf(
        ...
        "今日词云", "舔[<@一位用户>]", "metar[<机场ICAO代码>]", "摸鱼", "[<中国内地省级行政区/全国>]油价", "陪我聊天", "cos", "美女",
        "cat", "news", "来点[<mix>?][<r18>?][<tag，多个tag用'&'连接>?]", "文章[<内容>][<&字数>?]", "en[<待加密内容>][<&&key>]",
        "de[<待解密内容>][<&&key>]", "[<垃圾名>]是什么垃圾", "[<城市>?][<明天/后天>?]天气[<定位>?]", "爬[<@一位用户>]", "买家秀",
        "赞[<@一位用户>]", "丢[<@一位用户>]", "双色球[<双色球号码>]", "二维码[<二维码的内容>]"
    )

    val funcFriend = listOf(
        "help", "查询状态", "dice[<大于1的整数>]", "cos", "cat", "陪我聊天", "news", "[<中国内地省级行政区/全国>]油价", "买家秀",
