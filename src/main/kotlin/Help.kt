...
object Help {
    ...
    val funcGroup: List<String> = listOf(
        ...
        "dice[<大于1的整数>]", "占卜一下[<事件>]", "t[<内容>][(-><语言>)?]", "支持语言", "搜图[<一张或多张图片>?]", "python[<命令脚本>]",
        "今日词云", "舔[<@一位用户>]", "metar[<机场ICAO代码>]", "摸鱼", "二维码[<二维码的内容>]", "陪我聊天", "cos",
        "cat", "news", "来点[<tag，多个tag用'&'连接>?]", "文章[<内容>][<&字数>?]", "en[<待加密内容>][<&&key>]",
    ...
    val funcFriend = listOf(
        ...
        "metar[<机场ICAO代码>]", "来点[<tag，多个tag用'&'连接>?]", "文章[<内容>][<&字数>?]", "摸鱼",
